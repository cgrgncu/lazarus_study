...
+ 1. 繼續編輯有關第2個分頁「逆推工具」(Inversion_TabSheet):  
  ...
  + 1.2 第4個分頁「觀測資料預覽」(InversionInputObsDataPreview_TabSheet):
    ...
    + **1.2.3 在「InversionInputObsDataPreview_ToolBar」元件上按「右鍵>New Divider」，會增加一個新按鈕。預設名稱會是「ToolButton1」，修改「Name」為「InversionInputObsDataPreviewSeparator1_ToolButton」**
