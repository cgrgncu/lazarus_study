...
```
+ 2.2 去修改「ForwardModelingRun_ToolButton」的「Event」頁面下「OnClick」為如下程式碼。(改成ERTMaker_SimulateForTimeSeries_v20251031b.cpython-312.pyc、ERTMaker_SimulateForTimeSeries_v20251101b.cpython-312.pyc)
```pascal
