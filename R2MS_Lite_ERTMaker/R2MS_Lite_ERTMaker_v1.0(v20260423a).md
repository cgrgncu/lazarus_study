...
+ 作者: HsiupoYeh  
+ 更新日期: 2026-04-23
+ 從 **R2MS_Lite_ERTMaker_v1.0(v20260419a).md** 開始，新增功能。
...
```
### 功能 
+ 2.1 去修改「InversionModelingRun_ToolButton」的「Event」頁面下「OnClick」為如下程式碼。
```pascal
...
begin
  ...
  try
    InversionModelingSettingsNowJson_Memo.Lines.Strings[7-1] := ('"Mesh_Setting01_AutoMesh_Enable":"No",');
    //--------------------------------------------------------------------------
